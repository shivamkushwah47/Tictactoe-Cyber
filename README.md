...
Ek fully functional, animated Tic-Tac-Toe game Flutter mein bana hua.

## ✨ Features

### Gameplay
- ⚔️ **2 Player Mode** — ek device par dono khelo
- 🤖 **vs AI Mode** — computer ke against challenge
- 🧠 **3 AI Levels**: Easy, Medium, Hard (Hard = unbeatable Minimax AI!)

### Animations (Flutter Level)
- 🎯 Piece placement: scale + rotate spring animation
- 💥 Haptic feedback har move par
- ✨ Winning line: animated glowing laser beam (CustomPainter)
- 🏆 Win cells: pulse animation
- 📳 Draw: shake animation
- 🎊 Confetti burst jab koi jeete
- 🌊 Animated cyberpunk background (CustomPainter)
- 🔄 Score cards: active player pulse + glow
...
# 3. Run karo (connected device ya emulator pe)
flutter run
